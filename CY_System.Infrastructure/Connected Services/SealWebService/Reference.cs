...
namespace SealWebService
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("dotnet-svcutil", "1.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://183.62.140.54:8008/", ConfigurationName="SealWebService.SealWebServiceSoap")]
    public interface SealWebServiceSoap
    {
        ...
        System.Threading.Tasks.Task<SealWebService.ArrayOfXElement> GetDigitalStampAsync(string ticket, string str_szkid, string str_kyzm);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://183.62.140.54:8008/GetDigitalStamp1", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<SealWebService.ArrayOfXElement> GetDigitalStamp1Async(string ticket, string str_szkid, string str_kyzm);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<SealWebService.ArrayOfXElement> GetStampInfoAsync(string ticket, string kid, string yzm);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://183.62.140.54:8008/GetYzzb", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<SealWebService.ArrayOfXElement> GetYzzbAsync(string ticket, string sid);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://183.62.140.54:8008/GetYzdw", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<SealWebService.ArrayOfXElement> GetYzdwAsync(string ticket, string udwhz, string uyyzzh, string uzzjgdm, string uswdjh, string ucsi);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<SealWebService.ArrayOfXElement> GetEsealKDInfoAsync(string ticket, string key);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("dotnet-svcutil", "1.0.0.0")]
    public interface SealWebServiceSoapChannel : SealWebService.SealWebServiceSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("dotnet-svcutil", "1.0.0.0")]
    public partial class SealWebServiceSoapClient : System.ServiceModel.ClientBase<SealWebService.SealWebServiceSoap>, SealWebService.SealWebServiceSoap
    {
    ...
    static partial void ConfigureEndpoint(System.ServiceModel.Description.ServiceEndpoint serviceEndpoint, System.ServiceModel.Description.ClientCredentials clientCredentials);
        ...
        public System.Threading.Tasks.Task<SealWebService.ArrayOfXElement> GetDigitalStampAsync(string ticket, string str_szkid, string str_kyzm)
        {
            return base.Channel.GetDigitalStampAsync(ticket, str_szkid, str_kyzm);
        }
        
        public System.Threading.Tasks.Task<SealWebService.ArrayOfXElement> GetDigitalStamp1Async(string ticket, string str_szkid, string str_kyzm)
        {
        ...
        public System.Threading.Tasks.Task<SealWebService.ArrayOfXElement> GetStampInfoAsync(string ticket, string kid, string yzm)
        {
            return base.Channel.GetStampInfoAsync(ticket, kid, yzm);
        }
        
        public System.Threading.Tasks.Task<SealWebService.ArrayOfXElement> GetYzzbAsync(string ticket, string sid)
        {
            return base.Channel.GetYzzbAsync(ticket, sid);
        }
        
        public System.Threading.Tasks.Task<SealWebService.ArrayOfXElement> GetYzdwAsync(string ticket, string udwhz, string uyyzzh, string uzzjgdm, string uswdjh, string ucsi)
        {
        ...
        public System.Threading.Tasks.Task<SealWebService.ArrayOfXElement> GetEsealKDInfoAsync(string ticket, string key)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.SealWebServiceSoap))
            {
                return new System.ServiceModel.EndpointAddress("http://203.91.46.228/erpws/SealWebService.asmx");
            }
            if ((endpointConfiguration == EndpointConfiguration.SealWebServiceSoap12))
            {
                return new System.ServiceModel.EndpointAddress("http://203.91.46.228/erpws/SealWebService.asmx");
