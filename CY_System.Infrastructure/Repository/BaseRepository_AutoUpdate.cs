...
namespace CY_System.Infrastructure
{
    ...
    public class BaseRepository_AutoUpdate<T> : IRepository<T> where T : class
    {
        ...
        {
            return ConnectionFactory.CreateConnection(_connectionString, "sqlite");
        }

        public BaseRepository_AutoUpdate()
        {
            this._connectionString = CY_SystemConsts.ConnectionString_connAutoUpdate;
        }
        ...
        public IEnumerable<dynamic> RunSqlToList(string sql, object param = null)
        {
            throw new NotImplementedException();
        }

        public int RunSql(string sql, object param = null)
        {
            throw new NotImplementedException();
        }
    }
