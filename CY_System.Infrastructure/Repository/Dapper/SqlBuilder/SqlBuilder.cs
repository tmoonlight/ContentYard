...
{
    /// <summary>
    /// Dapper提供的sqlbuilder辅助类
    /// 使用示例 :  
    /// var builder = new SqlBuilder();
    /// var selector = builder.AddTemplate("select * from bigTable /**where**/");
    /// conn.Where("name" new {name = "testname"});
    /// conn.Query(builder.RawSql,selector.Parameters);
    /// 其中/**where**/是替换符
    /// </summary>
